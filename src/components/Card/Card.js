    ...
    <>
      <div className={styles.cardContainer}>
        <div className={styles.cardIdWrapper}>
          <div className={styles.cardId}>{props.cardDetails.id}</div>
          <div className={styles.cardProfile}>
            <div className={styles.cardProfileInitial}>
            ...
            <div
              className={
                props.cardDetails.userObj.available
                  ? `${styles.cardProfileAvailable} ${styles.availableTrue}`
                  : styles.cardProfileAvailable
              }
            ></div>
          </div>
        </div>
        <div className={styles.cardTitle}>{props.cardDetails.title}</div>
        <div className={styles.cardTag}>
          ...
          {props.cardDetails.tag.map((tag) => {
            return (
              <div className={styles.cardTagBox} key={tag}>
                <div className={styles.cardTagTitle}>{tag}</div>
              </div>
            );
          })}
        </div>
